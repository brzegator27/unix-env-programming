...
{
    char **argv;
    /* The command argv[0] and list of its arguments argv[1...argc-1]  */
    int argc;
    /* The numer of elements in the argv array  */
    int conjuction;
    /* Indicates which operator (|| or &&) was used before this command */
